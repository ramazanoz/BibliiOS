#
# Be sure to run `pod lib lint BibliOS-SDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'BibliOS-SDK'
  s.version          = '0.0.2'
  s.summary          = 'This framework is a tool to make payments.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'BibliOS/**/*'
  s.swift_version = "4.2"

  
  # s.resource_bundles = {
  #   'BibliOS-SDK' => ['BibliOS-SDK/Assets/*.png']
  # }
